...
const FAL_MODEL = `fal-ai/flux-pro/v1/canny`; // `fal-ai/flux-pro/v1.1-ultra/redux`;
  ...
  try {
    ...
    const result = await fal.subscribe(FAL_MODEL, {
      input: {
        ...
        safety_tolerance: "2",
        output_format: "jpeg",
        control_image_url: imageDataUri,  // Use the base64 data URI        
        prompt: `A whimsical pencil sketch of an otherworldly creature with an oversized head in the style of Salvidor Dali. The top third shows wide, expressive eyes with long lashes and thin, arched eyebrows. The middle section depicts a mouth stretched into an impish grin, revealing teeth. The bottom portion consists of a plump, rounded body with thin, stick-like limbs ending in pointed claws, standing on a patch of grass with stylized sailboats in the background.
        `
      },
      logs: true,
